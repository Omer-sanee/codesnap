...
// ===========================================
// NEW & IMPROVED: REPORT BUG COMMAND (RENAMED)
// ===========================================
function reportBug() {
...
## 📷 Screenshots
<!-- If you have screenshots, save them in: ${HISTORY_DIR} -->
...
*Report generated by Spider Screenshot v1.5.1*
`;
            if (!fs.existsSync(HISTORY_DIR)) {
...
function viewEnhancedHistory() {
    try {
        ...
        // Create enhanced list with metadata
...
function activate(context) {
    ...
    const disposables = [];
    // ===========================================
    // SPIDER SCREENSHOT COMMANDS (4)
    // ===========================================
    // Command 1: Settings
    disposables.push(vscode.commands.registerCommand('spiderScreenshot.settings', () => {
        SettingsPanel_1.default.show(context.extensionUri);
    }));
    // Command 2: Upgrade to Pro
    disposables.push(vscode.commands.registerCommand('spiderScreenshot.upgradeToPro', () => __awaiter(this, void 0, void 0, function* () {
    ...
    // Command 3: REPORT BUG (NEW NAME - GUARANTEED TO WORK)
    disposables.push(vscode.commands.registerCommand('spiderScreenshot.reportBug', () => {
        reportBug();
    }));
    // Command 4: Show Help
    disposables.push(vscode.commands.registerCommand('spiderScreenshot.showHelp', () => {
        (0, showHelp_1.showHelpNotification)();
    }));
    // =====================================
    // CODESNAP COMMANDS (10)
    // =====================================
    // Command 5: Save Snapshot (Enhanced)
    disposables.push(vscode.commands.registerCommand('codesnap.saveCodeHistory', () => __awaiter(this, void 0, void 0, function* () {
        yield saveEnhancedSnapshot();
    })));
    // Command 6: View History (Enhanced)
    disposables.push(vscode.commands.registerCommand('codesnap.viewHistory', () => {
        viewEnhancedHistory();
    }));
    // Command 7: Clear Snapshots
    disposables.push(vscode.commands.registerCommand('codesnap.clearSnapshots', () => {
        if (fs.existsSync(HISTORY_DIR)) {
            fs.rmSync(HISTORY_DIR, { recursive: true, force: true });
    ...
    // Command 8: Backup Snapshots
    disposables.push(vscode.commands.registerCommand('codesnap.backupSnapshots', () => {
        backupAllSnapshots();
    }));
    // Command 9: Restore from Backup
    disposables.push(vscode.commands.registerCommand('codesnap.restoreBackup', () => {
        restoreFromBackup();
    }));
    // Command 10: Open Snapshot Folder
    disposables.push(vscode.commands.registerCommand('codesnap.openSnapshotFolder', () => {
        openSavedFolder();
    }));
    // Command 11: Show Logs
    disposables.push(vscode.commands.registerCommand('codesnap.showLogs', () => {
        showLogs();
    }));
    // Command 12: Show Latest Snapshot
    disposables.push(vscode.commands.registerCommand('codesnap.showLatestSnapshot', () => {
        showLatestSnapshot();
    }));
    // Command 13: Show Save Location
    disposables.push(vscode.commands.registerCommand('codesnap.showSaveLocation', () => {
        vscode.window.showInformationMessage(`📁 Your snapshots are saved in:\n${HISTORY_DIR}`);
    }));
    // Command 14: Enter License Key
    disposables.push(vscode.commands.registerCommand('codesnap.enterLicenseKey', () => __awaiter(this, void 0, void 0, function* () {
    ...
    console.log('   - spiderScreenshot.settings');
    console.log('   - spiderScreenshot.upgradeToPro');
    console.log('   - spiderScreenshot.reportBug (NEW!)');
    console.log('   - spiderScreenshot.showHelp');
    console.log('   - codesnap.saveCodeHistory (Enhanced)');
    console.log('   - codesnap.viewHistory (Enhanced)');
    console.log('   - codesnap.clearSnapshots');
    console.log('   - codesnap.backupSnapshots');
    console.log('   - codesnap.restoreBackup');
    console.log('   - codesnap.openSnapshotFolder');
    console.log('   - codesnap.showLogs');
    console.log('   - codesnap.showLatestSnapshot');
    console.log('   - codesnap.showSaveLocation');
    console.log('   - codesnap.enterLicenseKey');
}
function deactivate() { }
