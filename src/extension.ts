...
export function activate(context: vscode.ExtensionContext) {
  ...
  disposables.push(
    vscode.commands.registerCommand('spiderScreenshot.reportBug', () => {
      reportBug();
    })
  );
  ...
  // Command 4: Show Help
  disposables.push(
    vscode.commands.registerCommand('spiderScreenshot.showHelp', () => {
  ...
  disposables.push(
    vscode.commands.registerCommand('codesnap.viewHistory', () => {
      viewEnhancedHistory();
    })
  );
  ...
  disposables.push(
    vscode.commands.registerCommand('codesnap.clearSnapshots', () => {
      if (fs.existsSync(HISTORY_DIR)) {
        fs.rmSync(HISTORY_DIR, { recursive: true, force: true });
  ...
  disposables.push(
    vscode.commands.registerCommand('codesnap.backupSnapshots', () => {
      backupAllSnapshots();
    })
  );
  ...
  disposables.push(
    vscode.commands.registerCommand('codesnap.restoreBackup', () => {
      restoreFromBackup();
    })
  );
  ...
  disposables.push(
    vscode.commands.registerCommand('codesnap.openSnapshotFolder', () => {
      openSavedFolder();
    })
  );
  ...
  disposables.push(
    vscode.commands.registerCommand('codesnap.showLogs', () => {
      showLogs();
    })
  );
  ...
  disposables.push(
    vscode.commands.registerCommand('codesnap.showLatestSnapshot', () => {
      showLatestSnapshot();
    })
  );
